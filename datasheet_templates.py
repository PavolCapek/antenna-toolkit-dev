...
NETQUI_1POL_TEMPLATE_MANIFEST = TemplateManifest(
    ...
    chart_layout=TemplateChartManifest(
        ...
        slots=(
            ...
            TemplateChartSlot("beamwidth_e_plane", 2, "beamwidth_plane", plane="e-plane", legend_mode="netqui_side"),
            TemplateChartSlot("beamwidth_h_plane", 3, "beamwidth_plane", plane="h-plane", legend_mode="netqui_side"),
            TemplateChartSlot("radiation_low", 4, "polar_combined_triplet", frequency_role="low", legend_mode="netqui_bottom"),
            TemplateChartSlot("radiation_mid", 5, "polar_combined_triplet", frequency_role="mid", legend_mode="netqui_bottom"),
            TemplateChartSlot("radiation_high", 6, "polar_combined_triplet", frequency_role="high", legend_mode="netqui_bottom"),
        ),
        slot_order="rows",
    ),
