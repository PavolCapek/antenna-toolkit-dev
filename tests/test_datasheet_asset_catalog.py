...
class DatasheetAssetCatalogTests(unittest.TestCase):
    def test_catalog_builds_stable_items_from_current_manifest_keys(self) -> None:
        ...
        self.assertEqual(by_id["beam_efficiency"].label, "Beam Efficiency")
        self.assertEqual(by_id["beam_efficiency"].chart_family, "beam_efficiency")
        self.assertEqual(by_id["beam_efficiency"].manifest_key, "beam_efficiency")
        self.assertEqual(by_id["beam_efficiency"].svg_path, root / "sample-beam-efficiency.svg")
