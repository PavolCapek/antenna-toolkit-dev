...
from plotting.config import (
    ...
    DEFAULT_LEGEND_LINE_WIDTH,
    DEFAULT_PLOT_FONT_SIZE,
    DEFAULT_PLOT_LINE_WIDTH,
    LEGEND_EXPORT_PAD_BOTTOM_PX,
...
def parse_color_list(raw: str | None, default: list[str] | None = None) -> list[str]:
    return _parse_color_list(raw, default if default is not None else DEFAULT_SOLID_COLORS)
...
def plot_xy(x, series_list, names, out_path, y_label,
    ...
    return render_cartesian_plot(
        ...
        legend_line_width=DEFAULT_LEGEND_LINE_WIDTH,
